/*! js-cookie v2.0.3 | MIT */ ! function(a) {
    if ("function" == typeof define && define.amd) define(a);
        ...
        c.noConflict = function() {
            return window.Cookies = b, c } } }(function() {
    function a() {
    ...
    function b(c) {
        function d(b, e, f) {
            ...
            if (arguments.length > 1) {
                ...
                try { g = JSON.stringify(e), /^[\{\[]/.test(g) && (e = g) } catch (i) {}
            ...
            for (var j = document.cookie ? document.cookie.split("; ") : [], k = /(%[0-9A-Z]{2})+/g, l = 0; l < j.length; l++) {
                var m = j[l].split("="),
                    ...
                    o = m.slice(1).join("="); '"' === o.charAt(0) && (o = o.slice(1, -1));
                try {
                    if (o = c && c(o, n) || o.replace(k, decodeURIComponent), this.json) try { o = JSON.parse(o) } catch (i) {}
                    if (b === n) { g = o;
                        break }
                    b || (g[n] = o) } catch (i) {} }
            return g }
        return d.get = d.set = d, d.getJSON = function() {
            return d.apply({ json: !0 }, [].slice.call(arguments)) }, d.defaults = {}, d.remove = function(b, c) { d(b, "", a(c, { expires: -1 })) }, d.withConverter = b, d }
    return b() });
